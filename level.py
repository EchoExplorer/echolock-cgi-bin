...
cursor.execute('''INSERT INTO LevelData(userName, currentLevel, trackCount,
  crashCount, stepCount, timeElapsed, totalEchoes, startTime, endTime, 
  exitAttempts, asciiLevelRep, levelRecord, dateTimeStamp)
VALUES(?,?,?,?,?,?,?,?,?,?,?,?,CURRENT_TIMESTAMP)''', (userName,
currentLevel, trackCount, crashCount, stepCount, timeElapsed, totalEchoes, 
startTime, endTime, exitAttempts, asciiLevelRep, levelRecord))
